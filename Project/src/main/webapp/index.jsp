...
<body>
	...
	<header>
	<div><img src="https://cu.bgfretail.com/images/common/logo.gif"/></div>
	<div><img src="http://gs25.gsretail.com/_ui/desktop/common/images/gscvs/common/logo.gif"></div>
	</header>
	<div class='prod_list'>
		<ul>
		<%
	...
	<div><a href="javascript:nextPage(1);">더보기</a></div>
</body>
</html>